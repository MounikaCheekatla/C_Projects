...
if(i==7)
{
    printf("1) Which one of the below is the first search engine in the internet world?\n\n");
    printf("1) Google\n");
    printf("1) Archie\n");
    printf("1) Wais\n");
    printf("1) Altavista\n");
    ...
    printf("2) Which one of the below is the first web browser invented in 1990?\n\n");
